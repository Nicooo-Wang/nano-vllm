...
class BlockManager:
    ...
    def _allocate_block(self, block_id: int) -> Block:
        ...
        assert block.ref_count == 0, "块已被分配"
        block.reset()
    ...
    def _deallocate_block(self, block_id: int) -> Block:
        ...
        3. 加入空闲队列
        """
        assert self.blocks[block_id].ref_count == 0, "块仍在使用中"
    ...
    def allocate(self, seq: Sequence):
        ...
        """
        assert not seq.block_table, "序列已有block table"
    ...
    def may_append(self, seq: Sequence):
        ...
        if len(seq) % self.block_size == 1:
            assert last_block.hash != -1, "当前block应该已哈希"
        ...
        # 例如：block_size=256，当前长度=256*k
            ...
            assert last_block.hash == -1, "刚填满的block应该无哈希"
        ...
        # 情况3：当前block未满，无需操作
            ...
            assert last_block.hash == -1, "未满的block应该无哈希"
